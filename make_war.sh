...
SRC_DIR=./src
JARS=$2/kbase/auth/kbase-auth-1398468950-3552bb2.jar:$2/servlet/servlet-api-2.5.jar:$2/jackson/jackson-annotations-2.2.3.jar:$2/jackson/jackson-core-2.2.3.jar:$2/jackson/jackson-databind-2.2.3.jar:$2/jetty/jetty-all-7.0.0.jar:$2/syslog4j/syslog4j-0.9.46.jar:$2/ini4j/ini4j-0.5.2.jar:$2/apache_commons/commons-io-2.4.jar:$2/apache_commons/commons-fileupload-1.2.2.jar:$2/kbase/common/kbase-common-0.0.3.jar:$2/jna/jna-3.4.0.jar
...
cp -r $SRC_DIR/us/kbase/genomecomparison/genome2ftp.properties $CLASSES_DIR/us/kbase/genomecomparison/
